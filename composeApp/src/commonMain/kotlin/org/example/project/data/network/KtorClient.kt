    ...
    private val client = HttpClient{
        ...
        install(Auth) {
            bearer {
                loadTokens {
                    BearerTokens(
                        accessToken = "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlYzc5NzRmYTk5NzBjZjIzM2U1N2RlNjM2Mzk5MWQ5ZiIsIm5iZiI6MTc1OTc3NDQ5My42MTksInN1YiI6IjY4ZTQwNzFkZTA3NTFlNjlhYmMyMmJiMyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.xDAERLJeFcTS7aQO-rAL2NDiQSBxgRbJnaqYT12JEhc",
                        refreshToken = "",
                    )
                }
            }
